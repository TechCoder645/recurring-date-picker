    ...
    <div className="min-h-screen flex flex-col justify-center py-12">
      ...
      <div className="text-center mb-16 animate-fade-in-up">
        ...
        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed animate-fade-in-up animation-delay-400">
          Create perfect recurring schedules in seconds. Similar to TickTick's powerful date picker - configure daily,
      ...
      <div className="text-center mt-16 animate-fade-in-up animation-delay-1200">
        <p className="text-gray-500">Built with ❤️ using Next.js, TypeScript, and Tailwind CSS</p>
      </div>
    </div>
  )
}
